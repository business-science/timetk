...
theme_tq_dark <- function(base_size = 11, base_family = "") {
    ...
    theme_tq(base_size = base_size, base_family = base_family) %+replace%
        ggplot2::theme(
            ...
            # Axes
            axis.ticks         = ggplot2::element_line(color = blue, size = rel(1/3)),

            # Panel
            panel.background   = ggplot2::element_rect(fill = grey, color = NA),
            panel.grid.major   = ggplot2::element_line(color = white, size = rel(1/3)),
            panel.grid.minor   = ggplot2::element_line(color = white, size = rel(1/3)),
