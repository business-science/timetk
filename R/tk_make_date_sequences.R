...
#'
#' # Date-Time Sequence - By Minute
#' tk_make_date_sequence("2017-01-01 01:01:00", "2017-01-01 02:01:00", by = "10 min")
#'
#' # Date-Time Sequence - By Second
#' tk_make_date_sequence("2016-01-01 01:01:02", "2016-01-01 01:01:04", by = "sec")
#'
