#' Constrained Interval Transformation
#'
...
#' # --- VECTOR ----
#'
#' value_interval <- log_interval_vec(d10_daily$value, limit_lower = 0, limit_upper = 2700)
#' value          <- log_interval_inv_vec(value_interval, limit_lower = 0, limit_upper = 2700)
#'
#'
