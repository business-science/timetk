...
- [Full Time Series Machine Learning and Feature Engineering Tutorial:](https://www.business-science.io/time-series/2020/03/18/time-series-machine-learning.html) Showcases the (NEW) `step_timeseries_signature()` for building ___200+ time series features.___

- [Visit the timetk website documentation](https://business-science.github.io/timetk/) for tutorials and a complete list of function references. 
...
knitr::include_graphics("man/figures/bikes_forecast.png")
```
...
4. __Conversion functions__: `tk_tbl`, `tk_ts`, `tk_xts`, `tk_zoo`, and
`tk_zooreg` convert time-based tibbles `tbl` to and from each of the main
