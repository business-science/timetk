...
* __Solution__: The new `sw_ts()` stores the original date or datetime index as a second index ("sweep index"). The default regularized index is retrieved with `sw_index()`.
