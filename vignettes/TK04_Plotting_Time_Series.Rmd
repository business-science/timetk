...
The `plot_time_series_boxplot()` function can be used to make box plots. Box plots use an aggregation, which is a key parameter defined by the `.period` argument.
